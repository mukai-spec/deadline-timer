...
###アラームの設定
wave_obj = sa.WaveObject.from_wave_file("music/Faded .wav")
###時間設定[入力]
layout1 = [
    ...
    sg.InputText("0",key='-minutes-',size=(8,1)),sg.Text('分',font=('',18)),
    ],
    [sg.Button(image_filename='images/player_button.png',key='実行ボタン') ,sg.Text('',key='-出力-',size=(30,1))],
]
...
layout2 = [
            ...
            [sg.Image(filename='images/ganbarou.png',key=f'{i}') for i in range(1,10)]
          ]
# ウィンドウを作成する
